...
public class AStarApp {
    ...
    /**
     * Creates a new instance of rogov_lab_3.AStarApp with the specified map width and
     * height.
     **/
    ...
    {
        // Create a rogov_lab_3.Map2D object containing the current state of the user input.
